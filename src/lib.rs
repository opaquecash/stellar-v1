...
//   that could exhaust buffers in parsing or serialization.
// - MAX_ATTESTATION_DATA_LEN: Defines the maximum allowed size for
//   attestation data to prevent out-of-memory conditions in verification.
//
// All limits are chosen based on practical constraints of current
